title: Bazio First Blog Ever
author: BazioDEV
email: bazio.apple@gmail.com
theme: minima
description: > # this means to ignore newlines until "baseurl:"
 When the sun rise I'm a Junior Developer and Graphic Designer employee of the company.
 But!!! When the sun goes down I will be come a professional DJ that could make some crowd
 go wild for the whole night.
# social links
facebook_username: DJ.Bazio # DO NOT include the @ character, or else the build will fail!
github_username:  BazioDEV # DO NOT include the @ character, or else the build will fail!
